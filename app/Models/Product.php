 ...
 * schema="ProductCreate",
    ...
    * @OA\Property(title="Sku",property="sku",description="Sku of the product",type="string",example="REF123"),
    * @OA\Property(title="Price",property="price",description="price of the product",type="decimal",example=50000), 
    * @OA\Property(title="Category",property="category_id",description="Category of the product",type="string",example=3),
